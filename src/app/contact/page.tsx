...
export const metadata: Metadata = {
  title: 'Contact & Hire Me | Shouvik Das',
  description: 'Get in touch with Shouvik Das for Web3D development contracts, UI/UX design collaborations, and digital content creation inquiries.',
  openGraph: {
    title: 'Contact & Hire Me | Shouvik Das',
    description: 'Get in touch with Shouvik Das for Web3D development contracts, UI/UX design collaborations, and digital content creation inquiries.',
    url: 'https://shouvikdasportfolio.qzz.io/contact',
  ...
  alternates: {
    canonical: 'https://shouvikdasportfolio.qzz.io/contact',
  },
};
      ...
      <section className="relative min-h-screen pt-32 pb-24 overflow-hidden bg-transparent">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 text-left">
            <div className="bg-[#0b0814]/40 border border-white/5 p-5 rounded-2xl flex items-center gap-4 hover:border-white/10 transition-all duration-300">
              <div className="w-10 h-10 rounded-full bg-primary/10 border border-primary/25 flex items-center justify-center text-primary shrink-0">
                <Mail size={16} />
              </div>
              <div className="min-w-0">
                <span className="text-[9px] font-bold font-mono text-gray-500 uppercase tracking-wider block">Write Me Email</span>
                <a href={`mailto:${personalInfo.email}`} className="text-white hover:text-primary font-semibold text-xs md:text-sm transition-colors block truncate">{personalInfo.email}</a>
              </div>
            </div>
